...
virtualX:!1,virtualY:!1,width:"auto",wrap:!0,hwrap:!0};l.extend(a.options,{strAdd:"Adicionar",strDelete:"Borrar",strEdit:"Editar",strLoading:"Cargando",strNextResult:"Próximo resultado",strNoRows:"Sin registro.",strNothingFound:"No se encontro registro",strPrevResult:"Resultado anterior",strSearch:"Buscar",strSelectedmatches:"Seleccionado {0} de {1} match(es)"});l.widget("paramquery._pqGrid",l.ui.mouse,a);a=b._pqGrid.prototype;a.readCell=function(k,m,a,c,b){var e=m.dataIndx;if(!a||!a.isHidden(c,b)){if(m.nested){e=e.split(".");
