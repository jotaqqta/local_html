...
$(document).ready(function() {
    ...
    $("#co_nuevo").on("click", fn_muestra_nuevo);
...
function fn_setea_grid_principal()
{
    ...
    var obj = {
        ...
        toolbar:
       {
           ...
           items:
           [
               { type: "button", label: " Agregar"      ,  attr:"id=co_nuevo"     , cls:"btn btn-primary"},
    ...
    obj.colModel = [            
        { title: "Rol", width: 120, dataType: "string", dataIndx: "c1", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Nombre", width: 250, dataType: "string", dataIndx: "c2", halign:"center", align:"left",
			filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Rol Padre", width: 120, dataType: "float", dataIndx: "c3", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Nombre Padre", width: 250, dataType: "string", dataIndx: "c4", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Permisos", width: 300, dataType: "string", dataIndx: "c5", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Área Comercial", width: 200, dataType: "string", dataIndx: "c6", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} },
        { title: "Regional", width: 200, dataType: "string", dataIndx: "c7", halign:"center", align:"left",
            filter: { type: "textbox", condition: "contain", listeners: ["keyup"]} }
    ];
    ...
    obj2.colModel = [ 
        { title: "N°", width: "10%", dataType: "string", dataIndx: "c1", halign:"center", align:"center" },
        { title: "Permiso de Ajuste", width: "70%", dataType: "string", dataIndx: "c2", halign:"center", align:"left" },
        { title: "Permitido", dataIndx: "c3", width: "20%", align: "center", resizable: false,
        ...
        { title: "Permiso_ant", width: 0, dataType: "bool", dataIndx: "c4", halign:"center", align:"left", hidden:true  }
    ];
		
    
    $grid2 = $("#div_grid2").pqGrid(obj2);
	$grid2.pqGrid( "scrollRow", { rowIndxPage: 10 } );	
    ...
    var obj3 = {
      ...
      // showTop: true,
        ...
        toolbar:
        {
            ...
            items:
            [
                { type: "button", label: " Excel"        ,  attr:"id=co_excel2"       , cls:"btn btn-primary"},
            ]
        }
    ...
    obj3.colModel = [ 
        { title: "Rol", width: 120, dataType: "string", dataIndx: "c1", halign:"center", align:"left"},
        { title: "Nombre", width: 300, dataType: "string", dataIndx: "c2", halign:"center", align:"left"},
        { title: "Área Comercial", width: 300, dataType: "string", dataIndx: "c3", halign:"center", align:"left"},
        { title: "Regional", width: 300, dataType: "string", dataIndx: "c4", halign:"center", align:"left"}
    ];
		
    
    $grid3 = $("#div_grid3").pqGrid(obj3);
...
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*	
function fn_muestra_edicion()
{
    var v_rol = g_rol_selec;
    
    if (v_rol == "")
    {
        fn_mensaje_boostrap("DEBE SELECCIONAR UN ROL PARA EDITAR...", g_tit , $(""));
        return 0;
    }
    ...
    $("#tx_rol1").val(g_rol_selec);
    $("#tx_rol_edit").val(g_rol_selec);
    $("#co_leer1").hide();
    $("#co_cancelar1").hide();
    fn_carga_datos();
    fn_carga_datos2();
...
function fn_muestra_nuevo()
{
    ...
    $("#co_cancelar2").prop("disabled", true);
    $("#co_leer1").show();
    $("#co_cancelar1").show();
    $("#div_secun").slideDown();
    $("#bd_prin").slideUp();
...
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*	
function fn_carga_grid2()
{
    
    parameters = {
        "func":"fn_dat_grilla_per",
        "empresa":$("#Empresa").val(),
        "RolFun":$("#RolFun").val(),
        "rol":$("#Rol").val(),
        "ip":$("#Ip").val(),
    ...
    HablaServidor("ajuste_rol_grid2.json",parameters,"json", function(text) 
    {
        $grid2.pqGrid( "option", "dataModel.data", text);
...
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*	
function fn_carga_grid3()
{
    
    parameters = {
        "func":"fn_dat_grilla_hijos",
        "empresa":$("#Empresa").val(),
        "RolFun":$("#RolFun").val(),
        "rol":$("#Rol").val(),
        "ip":$("#Ip").val(),
    ...
    HablaServidor("ajuste_rol_grid3.json",parameters,"json", function(text) 
    {
        $grid3.pqGrid( "option", "dataModel.data", text);
        $grid3.pqGrid( "refreshDataAndView" );
    });
