...
$(document).ready(function() {
	...
	*/
	...
	$("#div_msg_bts").load("bootstrap_msn.htm", function() {  //
    ...
    $("#co_leer").on("click", function(){
	       //Validación de informacion
            if( $("#fec_proc").val() == "" && $("#fec_est").val() == ""){
                fn_mensaje_boostrap("Faltan Datos. Debe diligenciar una de las fechas", g_titulo, $("#fec_proc"));
                return;
            }
